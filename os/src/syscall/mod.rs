...
pub fn syscall(syscall_id: usize, args: [usize; 6]) -> isize {
    ...
    match syscall_id {
        ...
        SYSCALL_UNMOUNT2 => sys_unmount2(args[0] as *mut u8, args[1] as u32),
        SYSCALL_MKDIRAT => sys_mkdirat(args[0] as isize, args[1] as *mut u8, args[2] as u32),
        SYSCALL_GETDENTS64 => sys_getdents64(args[0], args[1] as *mut u8, args[2]),
        SYSCALL_CHDIR => sys_chdir(args[0] as *mut u8),
        ...
        SYSCALL_UNLINKAT => sys_unlinkat(args[0] as isize, args[1] as *mut u8, args[2] as u32),
